...
entity Employees : cuid, managed { 
    ...
    skillAssignments : Composition of many EmployeeSkillAssignments on skillAssignments.employee = $self; 
}
...
entity Skills : cuid, managed { 
    ...
    employeeAssignments : Association to many EmployeeSkillAssignments on employeeAssignments.skill = $self; 
}
